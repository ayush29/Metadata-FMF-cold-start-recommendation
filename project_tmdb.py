...
def alternateOptimization(rating_matrix,feature_matrix, NUM_OF_FACTORS):
...
if __name__ == "__main__":
    # Get the Data
    ratingDF,featureDF =getUserFeatureMatrix("./the-movies-dataset/ratings.csv","./movies_cross_features.csv",500)
...
#     (User_Movie_Dict, data) = getRatingMatrix("ratings.dat")
    ...
    (decisionTree, movie_vector) = alternateOptimization(train_rating,train_feature, NUM_OF_FACTORS)
